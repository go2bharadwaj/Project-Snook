...
function game(){  
            ...
            let incorrect_num = generateRandom(-10, 10, correct_num); //glitch not loading test tomorrow prevents correct answer twice, exclude the correct answer
            var combo = 0;
            LoadHeader();
...
//______________________________________________________________________________________________________________________________________________________________________________________________
            ...
            function LoadHeader(){
              // add animation
              document.getElementById("header1").innerHTML = " Beginner ";
            ...
            function LoadTotal(total){ 
                  document.getElementById("third").innerHTML = "Score: " + total;
            }
